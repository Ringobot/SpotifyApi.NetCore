...
namespace SpotifyApi.NetCore
{
    public interface IAlbumsApi
    {
        ...
        Task<Album> GetAlbum(string albumId, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>A Task that, once successfully completed, returns a full <see cref="Album"/> object.</returns>
        Task<Album> GetAlbum(string albumId, string market, string accessToken = null);
        ...
        Task<T> GetAlbum<T>(string albumId, string market, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>A Task that, once successfully completed, returns a full <see cref="Album"/> object.</returns>
        Task<Album> GetAlbumTracks(string albumId, string market = null, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>A Task that, once successfully completed, returns a full <see cref="Album"/> object.</returns>
        Task<Album> GetAlbumTracks(string albumId, (int limit, int offset) limitOffset, string market = null, string accessToken = null);
        ...
        /// <typeparam name="T">Optionally provide your own type to deserialise Spotify's response to.</typeparam>
        /// <returns>A Task that, once successfully completed, returns a Model of T.</returns>        
        Task<T> GetAlbumTracks<T>(string albumId, (int limit, int offset) limitOffset, string market = null, string accessToken = null);
        ...
        Task<Album[]> GetAlbums(string[] albumIds, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>A Task that, once successfully completed, returns an array of full <see cref="Album"/> objects.</returns>
        Task<Album[]> GetAlbums(string[] albumIds, string market, string accessToken = null);
        ...
        /// <typeparam name="T">Optionally provide your own type to deserialise Spotify's response to.</typeparam>
        /// <returns>A Task that, once successfully completed, returns a Model of T.</returns>
        Task<T> GetAlbums<T>(string[] albumIds, string market, string accessToken = null);
        ...
        Task<AlbumsSearchResult> SearchAlbums(string query, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>Task of <see cref="AlbumsSearchResult" /></returns>
        Task<AlbumsSearchResult> SearchAlbums(string query, string market, string accessToken = null);
        ...
        /// <param name="accessToken">Optional. A valid access token from the Spotify Accounts service.</param>
        /// <returns>Task of <see cref="AlbumsSearchResult" /></returns>
        Task<AlbumsSearchResult> SearchTracks(string query, string market, (int limit, int offset) limitOffset, string accessToken = null);
