...
namespace SpotifyApi.NetCore
{
    public interface IPlayerApi
    {
        ...
        [Obsolete("userHash overrides Will be removed in vNext. Use bearerToken parameter instead.")]
        ...
        Task PlayTracks(string spotifyTrackId, string bearerToken = null, string deviceId = null, long positionMs = 0);
        ...
        /// next song.</param>
        /// <remarks> https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ </remarks>
        Task PlayTracks(string[] spotifyTrackIds, string bearerToken = null, string deviceId = null, long positionMs = 0);
        ...
        /// </remarks>
        Task PlayAlbum(string albumId, string bearerToken = null, string deviceId = null, long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ 
        /// </remarks>
        Task PlayAlbumOffset(string albumId, string offsetTrackId, string bearerToken = null, string deviceId = null, 
            long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ 
        /// </remarks>
        Task PlayAlbumOffset(string albumId, int offsetPosition, string bearerToken = null, string deviceId = null, 
            long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ 
        /// </remarks>
        Task PlayPlaylist(string playlistId, string bearerToken = null, string deviceId = null,
            long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ 
        /// </remarks>
        Task PlayPlaylistOffset(string playlistId, string offsetTrackId, string bearerToken = null, string deviceId = null, 
            long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/ 
        /// </remarks>
        Task PlayPlaylistOffset(string playlistId, int offsetPosition, string bearerToken = null, string deviceId = null, 
            long positionMs = 0);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/start-a-users-playback/
        /// </remarks>
        Task Play(string bearerToken = null, string deviceId = null);
        ...
        //Task<Device[]> GetDevices(string bearerToken = null); //TODO: In vNext
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/get-a-users-available-devices/
        /// </remarks>
        Task<T> GetDevices<T>(string bearerToken = null);
        ...
        /// </remarks>
        Task<CurrentPlaybackContext> GetCurrentPlaybackInfo(string bearerToken = null, string market = null);
        ...
        /// https://developer.spotify.com/documentation/web-api/reference/player/get-information-about-the-users-current-playback/
        /// </remarks>
        Task<T> GetCurrentPlaybackInfo<T>(string bearerToken = null, string market = null);
